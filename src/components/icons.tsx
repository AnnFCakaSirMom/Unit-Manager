...
export const Check: React.FC<IconProps> = CheckIcon;
export const Link: React.FC<IconProps> = (props) => <Icon {...props}><path d="M10 13l4-4" /><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></Icon>;
...
export const Info: React.FC<IconProps> = (props) => <Icon {...props}><circle cx="12" cy="12" r="10" /><line x1="12" x2="12" y1="16" y2="12" /><line x1="12" x2="12.01" y1="8" y2="8" /></Icon>;
export const Book: React.FC<IconProps> = (props) => <Icon {...props}><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" /><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" /></Icon>;
...
export const ArrowDownIcon: React.FC<IconProps> = (props) => <Icon {...props}><path d="M12 5v14" /><path d="m19 12-7 7-7-7" /></Icon>;
export const ArrowUpIcon: React.FC<IconProps> = (props) => <Icon {...props}><path d="M12 19V5" /><path d="m5 12 7-7 7 7" /></Icon>;